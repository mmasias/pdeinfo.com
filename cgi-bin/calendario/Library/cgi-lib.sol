...
# return the number to the main script, and close the counterfile.
...
# to this subroutine from the referencing routine.
...
# Assign to the local variable $file_name, the filename that we passed
# to this subroutine from the referencing routine and initialize $table.
